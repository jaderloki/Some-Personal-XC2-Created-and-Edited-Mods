...
static function X2AbilityTemplate CreateSavHiddenBladeKill()
{
	...
	StealthEffect.VisualizationFn = EffectFlyOver_Visualization;

	AbilityNameCondition = new class'XMBCondition_AbilityName';
	AbilityNameCondition.IncludeAbilityNames.AddItem('SavHiddenBladeStab');

	Template = SelfTargetTrigger('SavHiddenBladeKill', "img:///UILibrary_SavageItems.UIPerk_HiddenBlades", false, StealthEffect, 'AbilityActivated');//AbilityActivated
...
static function X2AbilityTemplate SavSerumYellowExposure()
{
	...
	// Permenant Armor
	PermenantMinorBoostEffect = new class'XMBEffect_PermanentStatChange';
	PermenantMinorBoostEffect.AddStatChange(eStat_ArmorMitigation, 0);
...
static function X2AbilityTemplate SavAdministerSerumViolet()
{
	...
	NTEPsiEffect.AbilityNames.AddItem('Soulfire');
	NTEPsiEffect.AbilityNames.AddItem('Stasis');
	NTEPsiEffect.AbilityNames.AddItem('Insanity');
	NTEPsiEffect.AbilityNames.AddItem('Inspire');
	NTEPsiEffect.AbilityNames.AddItem('Fuse');
	NTEPsiEffect.AbilityNames.AddItem('Domination');		
	NTEPsiEffect.AbilityNames.AddItem('NullLance');
	NTEPsiEffect.AbilityNames.AddItem('VoidRift');	
	NTEPsiEffect.AbilityNames.AddItem('PsiOperativeMindControlAbility');
	NTEPsiEffect.AbilityNames.AddItem('SAVMindCrush');
	NTEPsiEffect.AbilityNames.AddItem('IRI_PhaseWalk');
	NTEPsiEffect.AbilityNames.AddItem('IRI_NullWard');
	NTEPsiEffect.AbilityNames.AddItem('IRI_PsiReanimation');
	NTEPsiEffect.AbilityNames.AddItem('IRI_SoulMerge');
	NTEPsiEffect.AbilityNames.AddItem('IRI_SoulStorm');
	NTEPsiEffect.AbilityNames.AddItem('Volt');
	NTEPsiEffect.AbilityNames.AddItem('Amplify');
	NTEPsiEffect.AbilityNames.AddItem('Pillar');
	NTEPsiEffect.AbilityNames.AddItem('TemplarInvert');
	NTEPsiEffect.AbilityNames.AddItem('TemplarExchange');
	NTEPsiEffect.AbilityNames.AddItem('Ghost');
	NTEPsiEffect.AbilityNames.AddItem('IonicStorm');
	NTEPsiEffect.AbilityNames.AddItem('VoidConduit');
	NTEPsiEffect.AbilityNames.AddItem('StunStrike');
...
static function X2AbilityTemplate SavAdministerSerumOrange()
{
	...
	NTEEffect.AbilityNames.AddItem('StandardShot');
	NTEEffect.AbilityNames.AddItem('PistolStandardShot');
	NTEEffect.AbilityNames.AddItem('SniperStandardFire');
	NTEEffect.AbilityNames.AddItem('ThrowGrenade');
	NTEEffect.AbilityNames.AddItem('LaunchGrenade');
	NTEEffect.AbilityNames.AddItem('Reload');//Yeah its niche but threw it in there for players who use turnending reloads.
...
static function X2AbilityTemplate CreateSAVInjectListon()
{
	...
	PermenantMajorBuffEffect.AddStatChange(eStat_Strength, 3);
	PermenantMajorBuffEffect.ApplyChance = 70;
	MaxStatCondition = new class'X2Condition_UnitStatCheck';
	MaxStatCondition.AddCheckStat(eStat_Strength, 150, eCheck_LessThan);
	...
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Strength, 30);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Mobility, 2);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
static function X2AbilityTemplate CreateADVPCSSuspectLoyalty()
{
	...
	Template.IconImage = "img:///UILibrary_SavageItems.0_4_Perks.Traumatised";//=================================CHANGE IT
