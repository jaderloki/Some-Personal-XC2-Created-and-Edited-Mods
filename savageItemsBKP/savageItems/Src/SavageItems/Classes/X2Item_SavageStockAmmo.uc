...
static function X2AmmoTemplate CreateSAVHollowPointRounds()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.CriticalDamageLabel, , 1);
...
static function X2AmmoTemplate CreateDumbTracerRounds()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.AimLabel, eStat_Offense, 6);
...
//	Template.ModClipSize = -1; === This is unreliable so balance is now based around a tougher recoil mallus
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.PierceLabel, , -1);
...
static function X2AmmoTemplate CreateSavStunRounds()
{
	...
	Template.TargetEffects.AddItem(class'X2StatusEffects'.static.CreateStunnedStatusEffect(1, 40, false));
	DamageValue.Damage = -1;
	Template.AddAmmoDamageModifier(none, DamageValue);
...
static function X2AmmoTemplate CreateAAJRounds()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.PierceLabel, eStat_ArmorPiercing, 2);
	Template.SetUIStatMarkup(class'XLocalizedData'.default.CriticalChanceBonusLabel, eStat_CritChance, 10);
	Template.SetUIStatMarkup(class'XLocalizedData'.default.CriticalDamageLabel, , 1);
...
static function X2AmmoTemplate CreateAAJDERounds()
{
	...
	Template.SetUIStatMarkup(class'XLocalizedData'.default.PierceLabel, eStat_ArmorPiercing, 4);
	Template.SetUIStatMarkup(class'XLocalizedData'.default.ShredLabel, , 2);
	Template.SetUIStatMarkup(class'XLocalizedData'.default.CriticalDamageLabel, , 1);
...
static function X2AmmoTemplate CreateDisruptorRounds()
{
	...
	Template.TargetEffects.AddItem(class'X2StatusEffects'.static.CreateDisorientedStatusEffect(, , false));
	Template.TargetEffects.AddItem(class'X2StatusEffects'.static.CreateStunnedStatusEffect(1, 80, false));
	DamageValue.Damage = 1;
	Template.AddAmmoDamageModifier(none, DamageValue);
...
static function X2DataTemplate CreateHotshotRounds()
{
	...
	Template.AddAmmoDamageModifier(none, DamageValue);
	DamageValue.Damage = -1;
	Template.TargetEffects.AddItem(class'X2StatusEffects'.static.CreateBurningStatusEffect(2, 1));
	Template.TargetEffects.AddItem(class'X2StatusEffects'.static.CreateAcidBurningStatusEffect(2,1));
	Template.CanBeBuilt = false;
	Template.bInfiniteItem = false;
