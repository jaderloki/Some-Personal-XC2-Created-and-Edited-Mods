class X2Effect_SavTranquility extends X2Effect_Persistent;
...
DefaultProperties
{
	...
	DamageTypeImmunities(4)="Panic"
	DamageTypeImmunities(5)="Poison"
	DamageTypeImmunities(6)="Bleeding"
}