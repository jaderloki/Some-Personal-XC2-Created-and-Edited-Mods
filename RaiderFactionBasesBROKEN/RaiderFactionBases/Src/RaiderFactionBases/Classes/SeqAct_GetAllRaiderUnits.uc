class SeqAct_GetAllRaiderUnits extends SequenceAction;
...
function protected XGPlayer GetRequestedPlayer()
{
	...
	if(Battle != none)
	{
		...
		{
			RequestedPlayer = class'CHHelpers'.static.GetTeamOnePlayer();
		}
		else if(InputLinks[1].bHasImpulse)
		{
			RequestedPlayer = class'CHHelpers'.static.GetTeamTwoPlayer();
		}
	}
...
defaultproperties
{
	...
	InputLinks.Empty;
	InputLinks(0)=(LinkDesc="TeamOne")
	InputLinks(1)=(LinkDesc="TeamTwo")
