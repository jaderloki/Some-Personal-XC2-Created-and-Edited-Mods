...
static function XMBEffect_ConditionalBonus CreateDefectivePowerSupply_AimUp()
{
	...
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_PrototypeLaserRifle');
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_PrototypeLaserRifle_Perfected');

	WeaponCondition2 = new class'X2Condition_SavWeaponCategory';
	WeaponCondition2.IncludeWeaponCategories.AddItem('rifle');
