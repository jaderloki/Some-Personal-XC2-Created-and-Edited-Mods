...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(CreatePOISAVWeaponsTemplate());
	Templates.AddItem(CreatePOI_SAVDataCacheTemplate());
...
//This checks if you have alien encryption
...
//---------------------------------------------------------------------------------------
static function X2DataTemplate CreatePOISAVWeaponsTemplate()
{
	local X2PointOfInterestTemplate Template;

	`CREATE_X2POINTOFINTEREST_TEMPLATE(Template, 'POI_SAVWeaponsTemplate');

	return Template;
}
//---------------------------------------------------------------------------------------
static function X2DataTemplate CreatePOI_SAVDataCacheTemplate()
{
	local X2PointOfInterestTemplate Template;

	`CREATE_X2POINTOFINTEREST_TEMPLATE(Template, 'POI_SAVDataCacheTemplate');
