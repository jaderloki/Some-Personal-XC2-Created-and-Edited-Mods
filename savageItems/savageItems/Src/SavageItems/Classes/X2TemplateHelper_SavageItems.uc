			...
			if (WeaponTemplate != none)
			{
				...
				switch (WeaponTemplate.WeaponCat)
				{
					case 'Gremlin':
						...
						AddAbilityToGremlinTemplate(GremlinTemplate, 'SAVMedicalProtocolsAMOD', false);
						AddAbilityToGremlinTemplate(GremlinTemplate, 'SAVEngineeringProtocolsAMOD', false);
...
/*				switch (WeaponTemplate.WeaponCat)
				{
					case 'sparkbit':
						GremlinTemplate = X2GremlinTemplate(WeaponTemplate);
						AddAbilityToGremlinTemplate(GremlinTemplate, 'SAVHeavyMicroMissileVolley_BIT', false);
						AddAbilityToGremlinTemplate(GremlinTemplate, 'SAVAntiTankShot_BIT', false);
						AddAbilityToGremlinTemplate(GremlinTemplate, 'SAVHeavyAutocannonShot_BIT', false);
						break;
				}*/
			}
		}
