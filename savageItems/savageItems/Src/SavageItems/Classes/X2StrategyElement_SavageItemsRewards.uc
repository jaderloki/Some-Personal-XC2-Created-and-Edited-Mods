...
var config name	SAVWeaponsRewardDeck;
var config name	SAVSkirmisherCacheRewardDeck;
var config name	SAVTemplarCacheRewardDeck;
var config name	SAVReaperCacheRewardDeck;
var config name	SAVDataCacheRewardDeck;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Rewards.AddItem(CreateSAVWeaponsItemReward());
	Rewards.AddItem(CreateSAVSkirmisherCacheReward());
	Rewards.AddItem(CreateSAVTemplarCacheReward());
	Rewards.AddItem(CreateSAVReaperCacheReward());
	Rewards.AddItem(CreateSAVDataCacheReward());
...
//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSAVWeaponsItemReward()
{
	local X2RewardTemplate Template;

	`CREATE_X2Reward_TEMPLATE(Template, 'Reward_SAVWeaponsItemReward');

	Template.GenerateRewardFn = GenerateSAVWeaponsItemReward;
	Template.SetRewardFn = SAVSetItemReward;
	Template.GiveRewardFn = SAVGiveItemReward;
	Template.GetRewardStringFn = SAVGetItemRewardString;
	Template.GetRewardImageFn = SAVGetItemRewardImage;
...
static function GenerateSAVWeaponsItemReward(XComGameState_Reward RewardState, XComGameState NewGameState, optional float RewardScalar = 1.0, optional StateObjectReference RegionRef)
{	
	SAVGenerateDeckedItemReward(RewardState, NewGameState, default.SAVWeaponsRewardDeck);
}

//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSAVSkirmisherCacheReward()
{
	local X2RewardTemplate Template;

	`CREATE_X2Reward_TEMPLATE(Template, 'Reward_SAVSkirmisherCacheReward');

	Template.GenerateRewardFn = GenerateSAVSkirmisherCacheReward;
	Template.SetRewardFn = SAVSetItemReward;
	Template.GiveRewardFn = SAVGiveItemReward;
	Template.GetRewardStringFn = SAVGetItemRewardString;
	Template.GetRewardImageFn = SAVGetItemRewardImage;
...
static function GenerateSAVSkirmisherCacheReward(XComGameState_Reward RewardState, XComGameState NewGameState, optional float RewardScalar = 1.0, optional StateObjectReference RegionRef)
{	
	SAVGenerateDeckedItemReward(RewardState, NewGameState, default.SAVSkirmisherCacheRewardDeck);
}

//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSAVTemplarCacheReward()
{
	local X2RewardTemplate Template;

	`CREATE_X2Reward_TEMPLATE(Template, 'Reward_SAVTemplarCacheReward');

	Template.GenerateRewardFn = GenerateSAVTemplarCacheReward;
	Template.SetRewardFn = SAVSetItemReward;
	Template.GiveRewardFn = SAVGiveItemReward;
	Template.GetRewardStringFn = SAVGetItemRewardString;
	Template.GetRewardImageFn = SAVGetItemRewardImage;
...
static function GenerateSAVTemplarCacheReward(XComGameState_Reward RewardState, XComGameState NewGameState, optional float RewardScalar = 1.0, optional StateObjectReference RegionRef)
{	
	SAVGenerateDeckedItemReward(RewardState, NewGameState, default.SAVTemplarCacheRewardDeck);
}

//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSAVReaperCacheReward()
{
	local X2RewardTemplate Template;

	`CREATE_X2Reward_TEMPLATE(Template, 'Reward_SAVReaperCacheReward');

	Template.GenerateRewardFn = GenerateSAVReaperCacheReward;
	Template.SetRewardFn = SAVSetItemReward;
	Template.GiveRewardFn = SAVGiveItemReward;
	Template.GetRewardStringFn = SAVGetItemRewardString;
	Template.GetRewardImageFn = SAVGetItemRewardImage;
...
static function GenerateSAVReaperCacheReward(XComGameState_Reward RewardState, XComGameState NewGameState, optional float RewardScalar = 1.0, optional StateObjectReference RegionRef)
{	
	SAVGenerateDeckedItemReward(RewardState, NewGameState, default.SAVReaperCacheRewardDeck);
}

//---------------------------------------------------------------------------------------
static function X2DataTemplate CreateSAVDataCacheReward()
{
	local X2RewardTemplate Template;

	`CREATE_X2Reward_TEMPLATE(Template, 'Reward_SAVDataCacheReward');

	Template.GenerateRewardFn = GenerateSAVDataCacheReward;
	Template.SetRewardFn = SAVSetItemReward;
	Template.GiveRewardFn = SAVGiveItemReward;
	Template.GetRewardStringFn = SAVGetItemRewardString;
	Template.GetRewardImageFn = SAVGetItemRewardImage;
...
static function GenerateSAVDataCacheReward(XComGameState_Reward RewardState, XComGameState NewGameState, optional float RewardScalar = 1.0, optional StateObjectReference RegionRef)
{	
	SAVGenerateDeckedItemReward(RewardState, NewGameState, default.SAVDataCacheRewardDeck);
}
