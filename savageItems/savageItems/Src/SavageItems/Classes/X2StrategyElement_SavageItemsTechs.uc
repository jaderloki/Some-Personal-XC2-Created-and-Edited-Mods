...
//AyTechs
Techs.AddItem(CreateTechStudySAVXenotechnology());
...
Techs.AddItem(CreateAlienTechItemRewardDeck());
Techs.AddItem(CreateSAVWeaponsRewardDeck());
Techs.AddItem(CreateSAVSkirmisherCacheRewardDeck());
Techs.AddItem(CreateSAVTemplarCacheRewardDeck());
Techs.AddItem(CreateSAVReaperCacheRewardDeck());
Techs.AddItem(CreateSAVDataCacheRewardDeck());
...
//AyTechs
/////////////////////////////////
static function X2DataTemplate CreateTechStudySAVXenotechnology()
{
	local X2TechTemplate Template;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'StudySAVXenotechnology');
	Template.PointsToComplete = 2000;
	Template.SortingTier = 1;
	Template.strImage = "img:///UILibrary_SavageItems.TECH_Xenotech";
...
static function X2DataTemplate CreateTechStudySAVAlienNanotech()
{
	...
	// Requirements
	Template.Requirements.RequiredTechs.AddItem('StudySAVXenotechnology');
	Template.Requirements.RequiredItems.AddItem('SAVAlienNanotech');
	Template.Requirements.bVisibleIfTechsNotMet = false;
...
static function X2DataTemplate CreateAlienTechItemRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'AlienTechItemRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('AlienTechItemRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'AlienTechItemRewards';
    return Template;
}

static function X2DataTemplate CreateSAVWeaponsRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SAVWeaponsRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('SAVWeaponsRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'SAVWeaponsRewards';
    return Template;
}

static function X2DataTemplate CreateSAVSkirmisherCacheRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SAVSkirmisherCacheRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('SAVSkirmisherCacheRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'SAVSkirmisherCacheRewards';
    return Template;
}

static function X2DataTemplate CreateSAVTemplarCacheRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SAVTemplarCacheRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('SAVTemplarCacheRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'SAVTemplarCacheRewards';
    return Template;
}

static function X2DataTemplate CreateSAVReaperCacheRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SAVReaperCacheRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('SAVReaperCacheRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'SAVReaperCacheRewards';
    return Template;
}

static function X2DataTemplate CreateSAVDataCacheRewardDeck()
{
    local X2TechTemplate Template;

    `CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SAVDataCacheRewardDeck');
	...
	Template.Requirements.RequiredTechs.AddItem('SAVDataCacheRewardDeck');

    Template.ResearchCompletedFn = GiveDeckedItemReward;
    Template.RewardDeck = 'SAVDataCacheRewards';
    return Template;
}
