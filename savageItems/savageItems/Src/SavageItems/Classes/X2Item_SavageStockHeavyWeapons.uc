...
var config int PLASMAROCKET_HEAVYWEAPON_TPV;
var config int SUPPLY_COST_PLASMAROCKET_HEAVYWEAPON;
var config int ECORE_COST_PLASMAROCKET_HEAVYWEAPON;
...
static function X2WeaponTemplate CreatePlasmaLauncherOverlay()
{
	...
	Template.TradingPostValue = Default.PLASMAROCKET_HEAVYWEAPON_TPV;

	// Cost
	Resources.ItemTemplateName = 'Supplies';
	Resources.Quantity = default.SUPPLY_COST_PLASMAROCKET_HEAVYWEAPON;
	Template.Cost.ResourceCosts.AddItem(Resources);

	Artifacts.ItemTemplateName = 'EleriumCore';
	Artifacts.Quantity = default.ECORE_COST_PLASMAROCKET_HEAVYWEAPON;
