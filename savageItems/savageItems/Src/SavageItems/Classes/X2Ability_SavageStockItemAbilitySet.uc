...
var config array<name> AllowedItemArray_SaboteurAModItems;
//var config array<name> AllowedItemArray_MunitionsAModAbilities;
var config array<name> AllowedItemArray_PartisanKnives;

var config int AMOD_XHEAVY_MOBILITY;//-2
var config int AMOD_XHEAVY_DODGE;//-20
var config float AMOD_XHEAVY_DETECTION;//-0.4f

var config int AMOD_VHEAVY_DODGE;//-10
var config int AMOD_VHEAVY_MOBILITY;//-2
var config float AMOD_VHEAVY_DETECTION;//-0.3f

var config int AMOD_HEAVY_DODGE;//-5
var config int AMOD_HEAVY_MOBILITY;//-1
var config float AMOD_HEAVY_DETECTION;//-0.2f

var config int AMOD_CUMBERSOME_DODGE;//-5
var config float AMOD_CUMBERSOME_DETECTION;//-0.1f

var config int AMOD_LIGHTWEIGHT_DODGE;//5
var config int AMOD_LIGHTWEIGHT_MOBILITY;//2
var config float AMOD_LIGHTWEIGHT_DETECTION;//0.25f
...
var config int SKIRMISHERBREACHING_GUN_TILE_WIDTH;
var config int SKIRMISHERBREACHING_GUN_TILE_LENGTH;

var config int RIFLE_MGUPGRADE_AIM;//5
var config int RIFLE_MGUPGRADE_DAMAGE;//1
var config int RIFLE_BMUPGRADE_CRITCHANCE;//5
var config int RIFLE_BMUPGRADE_DAMAGE;//1
var config int CANNON_MGUPGRADE_AIM;//5
var config int CANNON_MGUPGRADE_DAMAGE;//1
var config int CANNON_BMUPGRADE_CRITCHANCE;//5
var config int CANNON_BMUPGRADE_DAMAGE;//1
var config int SHOTGUN_MGUPGRADE_AIM;//5
var config int SHOTGUN_MGUPGRADE_DAMAGE;//1
var config int SHOTGUN_BMUPGRADE_CRITCHANCE;//5
var config int SHOTGUN_BMUPGRADE_DAMAGE;//1
var config int SNIPERRIFLE_MGUPGRADE_AIM;//5
var config int SNIPERRIFLE_MGUPGRADE_DAMAGE;//1
var config int SNIPERRIFLE_BMUPGRADE_CRITCHANCE;//5
var config int SNIPERRIFLE_BMUPGRADE_DAMAGE;//1
var config int PISTOL_MGUPGRADE_AIM;//5
var config int PISTOL_MGUPGRADE_DAMAGE;//1
var config int PISTOL_BMUPGRADE_CRITCHANCE;//5
var config int PISTOL_BMUPGRADE_DAMAGE;//1
var config int SWORD_MGUPGRADE_AIM;//5
var config int SWORD_MGUPGRADE_DAMAGE;//1
var config int SWORD_BMUPGRADE_CRITCHANCE;//5
var config int SWORD_BMUPGRADE_DAMAGE;//1
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(SAVReaperAmod());
	...
	Templates.AddItem(SAVBreachBangClear());
	...
	Templates.AddItem(ReaperGogglesEnhancedSenses());
	...
	Templates.AddItem(SkirmisherBreachingGunAbility());
	Templates.AddItem(SAVDynamoFocus());
	Templates.AddItem(VoltAnimset());
	Templates.AddItem(SAVTranslocatorFocus());
	Templates.AddItem(SAVPsionicDynamo());
	Templates.AddItem(SAVPsionicTranslocator());
	Templates.AddItem(SAVFocusOnInward());
	Templates.AddItem(SAVFocusOnDynamoOutward());
	Templates.AddItem(SAVFocusOnOutward());
///////////////////RESISTANCE WEAPON ABILITIES///////////////////////
	Templates.AddItem(SAVLegacyAssaultRifleUpgradeMG());
	Templates.AddItem(SAVLegacyAssaultRifleUpgradeBM());
	Templates.AddItem(SAVLegacyCannonUpgradeMG());
	Templates.AddItem(SAVLegacyCannonUpgradeBM());
	Templates.AddItem(SAVLegacyPistolUpgradeMG());
	Templates.AddItem(SAVLegacyPistolUpgradeBM());
	Templates.AddItem(SAVLegacySniperRifleUpgradeMG());
	Templates.AddItem(SAVLegacySniperRifleUpgradeBM());
	Templates.AddItem(SAVLegacyShotgunUpgradeMG());
	Templates.AddItem(SAVLegacyShotgunUpgradeBM());
	Templates.AddItem(SAVLegacySwordUpgradeMG());
	Templates.AddItem(SAVLegacySwordUpgradeBM());
	...
	Templates.AddItem(CreateSAVDefectivePowerSupply2());
	Templates.AddItem(SAVQuicksilverHands());
	Templates.AddItem(SAVQuicksilverReactions());
	Templates.AddItem(SAVViperfangPoison());
	Templates.AddItem(SAVTheVipersBite());
	Templates.AddItem(SAVTheVipersBite3());
	Templates.AddItem(CreateSAVJaggedEdge());
	Templates.AddItem(CreateSAVJaggedEdge3());
	Templates.AddItem(SAVEndlessVengeance_ReactionBonus());
	Templates.AddItem(SAV_EndlessVengeance());
	Templates.AddItem(SAV_EndlessVengeance3());
	Templates.AddItem(SAV_EndlessVengeance_Charges());
	Templates.AddItem(SAV_OE_Demolition());
	Templates.AddItem(SAV_OE_Demolition_Perfected());
///////////////////GREMLIN ABILITIES///////////////////////
//For Medical AMOD
	Templates.AddItem(CreateSavMedicalProtocol());//Used to check if the medical abilities should be available
	Templates.AddItem(CreateSAVMedicalProtocolsAMOD());//holds the Gremlin abilities, is basicly just there to clean things up in the armory
	...
	Templates.AddItem(MEDAmod_RegenBonusUses());
	Templates.AddItem(MEDAmod_Regen2BonusUses());
	Templates.AddItem(MEDAmod_NanoRegenBonusUses());
	Templates.AddItem(MEDAmod_CombatStimsBonusUses());
	Templates.AddItem(MEDAmod_CombatStims2BonusUses());
	Templates.AddItem(MEDAmod_StimulatorBonusUses());
	Templates.AddItem(MEDAmod_MedikitBonusUses());
	Templates.AddItem(MEDAmod_NanoMedikitBonusUses());
//For Engineering AMOD
	...
	Templates.AddItem(CreateSAVEngineeringProtocolsAMOD());
	Templates.AddItem(EngAmod_RepairKitBonusUses());
	Templates.AddItem(EngAmod_RepairKit2BonusUses());
	Templates.AddItem(EngAmod_PlatingKitGremlinBonusUses());
///////////////////TLM ARMOR UPGRADES///////////////////////
...
/////////////////////PCS ABILITIES///////////////////////
	Templates.AddItem(CreateSAVAddledMind());
	Templates.AddItem(CreateSAVTraumaticExperience());
	Templates.AddItem(CreateADVPCSSuspectLoyalty());
	Templates.AddItem(CreateSAV_MedicalPCSAbility());
	Templates.AddItem(CreateSAV_OverwhelmedPCSAbility());
	Templates.AddItem(CreateSAV_OverwhelmedPassivePCSAbility());
	Templates.AddItem(CreateSAV_StealthPCSAbility());
	Templates.AddItem(CreateSAV_SurvivalPCSAbility());
	Templates.AddItem(CreateSAV_CQBPCSAbility());
	Templates.AddItem(SAVPCSMarkTarget());
	Templates.AddItem(SAVPCSEnhancedReflexes());
	Templates.AddItem(SAVPCSAdventSecurityPass());
...
static function X2AbilityTemplate AddArmourModXheavy()
{
	...
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionModifier, default.AMOD_XHEAVY_DETECTION);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
//	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Dodge, default.VHEAVYAMOD_DODGE_SCALAR, MODOP_PostMultiplication);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionModifier, default.AMOD_VHEAVY_DETECTION);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
//	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Dodge, default.HEAVYAMOD_DODGE_SCALAR, MODOP_PostMultiplication);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionModifier, default.AMOD_HEAVY_DETECTION);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
//	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Dodge, default.HEAVYAMOD_DODGE_SCALAR, MODOP_PostMultiplication);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionModifier, default.AMOD_CUMBERSOME_DETECTION);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
//	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Dodge, default.LIGHTAMOD_DODGE_SCALAR, MODOP_PostMultiplication);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionModifier, default.AMOD_LIGHTWEIGHT_DETECTION);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
static function X2AbilityTemplate SAVReaperAmod()
{
	local X2AbilityTemplate                 Template;	
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;
	...
	local name AllowedItemNames_ReaperAModItems;


	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAVReaperAmod');
	Template.IconImage = "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility";
	...
	foreach default.AllowedItemArray_SaboteurAModItems(AllowedItemNames_ReaperAModItems)
	{
		BonusItemEffect.ApplyToNames.AddItem(AllowedItemNames_ReaperAModItems);
	}
	...
	ItemEffect.DataName = 'SAV_ReaperRemoteDetonator';
...
static function X2AbilityTemplate AddMagazineCarrierBonus()
{
	...
	Template.AddTargetEffect(BonusItemEffect);
	Template.AddTargetEffect(BonusItemEffect2);
	Template.AddTargetEffect(BonusItemEffect3);
	Template.AddTargetEffect(BonusItemEffect4);
...
static function X2AbilityTemplate AddGBandolierBonus()
{
	...
	// Add the XMBEffect_AddItemCharges as an extra effect.
	BonusItemEffect = new class'XMBEffect_AddItemCharges';
	BonusItemEffect.PerItemBonus = 2;
...
static function X2AbilityTemplate SAVBreachBangClear()
{
	local X2AbilityTemplate Template;
	...
	Effect.TriggeredEvent = 'BreachNClear';
	Effect.bShowFlyOver = true;
	Effect.CountValueName = 'BreachNClearUses';
	...
	Condition.IncludeWeaponNames.AddItem('FlashbangGrenade');
	Condition.IncludeWeaponNames.AddItem('BreachingGun');
	Condition.IncludeWeaponNames.AddItem('SAVSkirmisherMagBlaster');
//	Condition.IncludeWeaponNames.AddItem('AUXWEAPONNAME');//AuxLauncherSmoke
//	Condition.IncludeWeaponNames.AddItem('AUXWEAPONNAME');//AuxLauncherFlash
	...
	NameCondition.IncludeAbilityNames.AddItem('BreachingGunAbility');//BreachingTool
	NameCondition.IncludeAbilityNames.AddItem('SkirmisherBreachingGunAbility');//MagBlaster
//	NameCondition.IncludeAbilityNames.AddItem('AUXWEAPONABILITYNAME');//AuxLauncherSmoke
//	NameCondition.IncludeAbilityNames.AddItem('AUXWEAPONABILITYNAME');//AuxLauncherFlash
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template = SelfTargetActivated('SAVBreachBangClear', "img:///UILibrary_SavageItems.UIPerk_BreachNClear", true, Effect,, eCost_Free);
...
static function X2AbilityTemplate MedicalOverlayBonus()
{
	...
	// Add the XMBEffect_AddItemCharges as an extra effect.
	BonusItemEffect = new class'XMBEffect_AddItemCharges';
	BonusItemEffect.PerItemBonus = 3;
...
//	local name AllowedItemNames_EngeneeringAModAbilities;
	...
	// Add the XMBEffect_AddItemCharges as an extra effect.
	BonusItemEffect = new class'XMBEffect_AddItemCharges';
	BonusItemEffect.PerItemBonus = 5;
...
static function X2AbilityTemplate AddSkullCrushingStrength()
{
	...
	PersistentStatChangeEffect.BuildPersistentEffect(1, true, false, false);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Strength, 1.5f);
	Template.AddTargetEffect(PersistentStatChangeEffect);
...
static function X2AbilityTemplate AddDreadnaughtOverlayBonus()
{
	...
	PersistentStatChangeEffect.BuildPersistentEffect(1, true, false, false);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_ArmorMitigation, 4);
...
static function X2AbilityTemplate EnhancedSenses()
{
	...
	Template.IconImage = "img:///UILibrary_SavageItems.UIPerk_PassiveSensors";
...
static function X2AbilityTemplate ReaperGogglesEnhancedSenses()
{
	local X2AbilityTemplate                 Template;	
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;
//	local XMBEffect_ConditionalBonus		Effect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'ReaperGogglesEnhancedSenses');
	Template.IconImage = "img:///UILibrary_SavageItems.UIPerk_Reaper_Goggles";
	...
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Passive, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_SightRadius, 5);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_DetectionRadius, 1.75f, MODOP_PostMultiplication);
	Template.AddTargetEffect(PersistentStatChangeEffect);

/*	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'ReaperGogglesAim';
	Effect.AddToHitModifier(10, eHit_Success);
	Effect.AddToHitModifier(10, eHit_Crit);
	Effect.AbilityTargetConditions.AddItem(new class'XMBCondition_Concealed');
...
static function X2AbilityTemplate CommandDesignatorAnimset()
{
    ...
    AnimSets = new class'X2Effect_AdditionalAnimSets';
    AnimSets.EffectName = 'CommandDesignatorAnimset';
...
static function X2AbilityTemplate SkirmisherBreachingGunAbility()
{
	local X2AbilityTemplate                 Template;	
	local X2AbilityCost_Ammo                AmmoCost;
	local X2AbilityCost_ActionPoints    ActionPointCost;
    ...
    `CREATE_X2ABILITY_TEMPLATE(Template, 'SkirmisherBreachingGunAbility');
	...
	ConeMultiTarget = new class'X2AbilityMultiTarget_Cone';
	ConeMultiTarget.bUseWeaponRadius = true;
	ConeMultiTarget.ConeEndDiameter = default.SKIRMISHERBREACHING_GUN_TILE_WIDTH * class'XComWorldData'.const.WORLD_StepSize;
	ConeMultiTarget.ConeLength = default.SKIRMISHERBREACHING_GUN_TILE_LENGTH * class'XComWorldData'.const.WORLD_StepSize;
	Template.AbilityMultiTargetStyle = ConeMultiTarget;
...
static function X2AbilityTemplate	SAVDynamoFocus()
{
	local X2AbilityTemplate					Template;
	local XMBCondition_AbilityName			AbilityNameCondition;
	local XMBEffect_ConditionalBonus		Effect;
	local XMBEffect_BonusDamageByDamageType	Effect2;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAVDynamoFocus');

	Template.IconImage = "img:///UILibrary_SavageItems.UIPerk_TemplarDynamo_Focus";
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'DynamoAmodVoltBonus';
	...
	Effect2 = new class'XMBEffect_BonusDamageByDamageType';
	Effect2.EffectName = 'DynamoAmodPsiDamage';
	Effect2.RequiredDamageTypes.AddItem('Psi');
	Effect2.RequiredDamageTypes.AddItem('Mental');
	Effect2.DamageBonus = 1;
...
//Adds the animations used by the Shield Overlay
static function X2AbilityTemplate VoltAnimset()
{
    local X2AbilityTemplate                 Template;
    local X2Effect_AdditionalAnimSets        AnimSets;

    `CREATE_X2ABILITY_TEMPLATE(Template, 'VoltAnimset');
    ...
    AnimSets = new class'X2Effect_AdditionalAnimSets';
    AnimSets.EffectName = 'VoltAnimset';
	AnimSets.AddAnimSetWithPath("AnimSet'Templar_Volt_ANIM.Anims.AS_Volt'");
	AnimSets.AddAnimSetWithPath("AnimSet'Templar_GainingFocus_ANIM.Anims.AS_GainingFocus'");
    AnimSets.BuildPersistentEffect(1, true, false, false, eGameRule_TacticalGameStart);
    AnimSets.DuplicateResponse = eDupe_Ignore;
    Template.AddTargetEffect(AnimSets);
...
static function X2AbilityTemplate SAVTranslocatorFocus()
{
	local X2AbilityTemplate					Template;
	local XMBCondition_AbilityName			NameCondition;
	local XMBEffect_ConditionalStatChange	Effect;
	...
	Template = SelfTargetTrigger('SAVTranslocatorFocus', "img:///UILibrary_SavageItems.UIPerk_TemplarTranslocator_Focus", false, Effect, 'AbilityActivated');

	Effect.AddPersistentStatChange(eStat_Mobility, 1);
	Effect.AddPersistentStatChange(eStat_Dodge, 20);
	Effect.Conditions.AddItem(new class'XMBCondition_AbilityName');
	Effect.SetDisplayInfo(ePerkBuff_Bonus, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	Effect.BuildPersistentEffect(2, false, true, false, eGameRule_PlayerTurnEnd);
	Effect.DuplicateResponse = eDupe_Refresh;
	...
	NameCondition = new class'XMBCondition_AbilityName';
	NameCondition.IncludeAbilityNames.AddItem('TemplarInvert');
	NameCondition.IncludeAbilityNames.AddItem('TemplarExchange');
...
static function X2AbilityTemplate SAVPsionicDynamo()
{
	local XMBEffect_AddAbilityCharges	Effect;
	local X2AbilityTemplate				Template;
	local X2Effect_SavWillLoss			SavWillLossEffect;
	...
	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.AbilityNames.AddItem('SAVFocusOnInward');
	Effect.AbilityNames.AddItem('SAVFocusOnDynamoOutward');

	Effect.BonusCharges = 1;
	Effect.MaxCharges = 3;

	// Create the template as a helper function. This is an activated ability that doesn't cost an action.
	Template = SelfTargetActivated('SAVPsionicDynamo', "img:///UILibrary_SavageItems.UIPerk_TemplarDynamo_Meditation", false, Effect,, eCost_Single);
	...
	Template.AbilitySourceName = 'eAbilitySource_Psionic';
	Template.AdditionalAbilities.AddItem('SAVFocusOnInward');
	Template.AdditionalAbilities.AddItem('SAVFocusOnDynamoOutward');

	Template.BuildVisualizationFn = MeditationAnim_BuildVisualization;

	return Template;
}

static function X2AbilityTemplate SAVPsionicTranslocator()
{
	local XMBEffect_AddAbilityCharges	Effect;
	local X2AbilityTemplate				Template;
	local X2Effect_SavWillLoss			SavWillLossEffect;
	...
	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.AbilityNames.AddItem('SAVFocusOnInward');
	Effect.AbilityNames.AddItem('SAVFocusOnOutward');

	Effect.BonusCharges = 2;
	Effect.MaxCharges = 6;

	// Create the template as a helper function. This is an activated ability that doesn't cost an action.
	Template = SelfTargetActivated('SAVPsionicTranslocator', "img:///UILibrary_SavageItems.UIPerk_TemplarTranslocator_Meditation", false, Effect,, eCost_Single);
	...
	Template.AbilitySourceName = 'eAbilitySource_Psionic';
	Template.AdditionalAbilities.AddItem('SAVFocusOnInward');
	Template.AdditionalAbilities.AddItem('SAVFocusOnOutward');
...
static function X2AbilityTemplate SAVFocusOnDynamoOutward()
{
	local XMBEffect_ConditionalBonus	Effect;
	local X2AbilityTemplate				Template;
	local X2AbilityCost_Charges			ChargeCost;
	...
	// Create a conditional bonus effect
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'DynamoAmodOwtwardVoltBonus';
	...
	// Create the template as a helper function. This is an activated ability that doesn't cost an action.
	Template = SelfTargetActivated('SAVFocusOnDynamoOutward', "img:///UILibrary_SavageItems.UIPerk_TemplarDynamo_FocusOut", false, Effect,, eCost_Free);
	...
	ChargeCost = new class'X2AbilityCost_Charges';
	ChargeCost.NumCharges = 1;
	ChargeCost.SharedAbilityCharges.AddItem('SAVFocusOnInward');
	Template.AbilityCosts.AddItem(ChargeCost);

	AddCooldown(Template, 2);

	Template.AbilitySourceName = 'eAbilitySource_Psionic';
	Template.HideErrors.AddItem('AA_AbilityUnavailable');

	Template.BuildVisualizationFn = FocusAnim_BuildVisualization;

	return Template;
}

static function X2AbilityTemplate SAVFocusOnOutward()
{
	local X2Effect_GrantActionPoints	Effect;
	local X2AbilityTemplate				Template;
	local X2AbilityCost_Charges			ChargeCost;
	local X2AbilityCharges				Charges;
	local X2Effect_PersistentStatChange	ShieldStat;

	Effect = new class'X2Effect_GrantActionPoints';
	Effect.NumActionPoints = 1;
	Effect.PointType = class'X2CharacterTemplateManager'.default.MomentumActionPoint;

	// Create the template as a helper function. This is an activated ability that doesn't cost an action.
	Template = SelfTargetActivated('SAVFocusOnOutward', "img:///UILibrary_SavageItems.UIPerk_TemplarTranslocator_FocusOut", false, Effect,, eCost_Free);

	ShieldStat = new class'X2Effect_PersistentStatChange';
	ShieldStat.EffectName = 'ShieldAmp1';
	ShieldStat.BuildPersistentEffect(1, true, false, false);
	ShieldStat.AddPersistentStatChange(eStat_ShieldHP, 1);
	ShieldStat.DuplicateResponse = eDupe_Allow;
	Template.AddTargetEffect(ShieldStat);
...
static function X2AbilityTemplate SAVFocusOnInward()
{
	...
	// Create the template as a helper function. This is an activated ability that doesn't cost an action.
	Template = SelfTargetActivated('SAVFocusOnInward', "img:///UILibrary_SavageItems.UIPerk_TemplarDynamo_FocusIn", false, Effect,, eCost_Free);
	...
	ChargeCost = new class'X2AbilityCost_Charges';
	ChargeCost.NumCharges = 1;
	ChargeCost.SharedAbilityCharges.AddItem('SAVFocusOnOutward');
	ChargeCost.SharedAbilityCharges.AddItem('SAVFocusOnDynamoOutward');
	Template.AbilityCosts.AddItem(ChargeCost);
...
simulated function MeditationAnim_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability  Context;
	local StateObjectReference InteractingUnitRef;
	...
	SoundAndFlyOver = X2Action_PlaySoundAndFlyOver(class'X2Action_PlaySoundAndFlyOver'.static.AddToVisualizationTree(ActionMetadata, Context, false, ActionMetadata.LastActionAdded));
	SoundAndFlyOver.SetSoundAndFlyOverParameters(None, "", 'Meditaion', eColor_Good);

	PlayAnimationAction = X2Action_PlayAnimation(class'X2Action_PlayAnimation'.static.AddToVisualizationTree(ActionMetadata, Context, false, ActionMetadata.LastActionAdded));
	PlayAnimationAction.Params.AnimName = 'HL_GainingFocus';

}

simulated function FocusAnim_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability  Context;
	local StateObjectReference InteractingUnitRef;
	...
	SoundAndFlyOver = X2Action_PlaySoundAndFlyOver(class'X2Action_PlaySoundAndFlyOver'.static.AddToVisualizationTree(ActionMetadata, Context, false, ActionMetadata.LastActionAdded));
	SoundAndFlyOver.SetSoundAndFlyOverParameters(None, "", 'Focus', eColor_Good);

	PlayAnimationAction = X2Action_PlayAnimation(class'X2Action_PlayAnimation'.static.AddToVisualizationTree(ActionMetadata, Context, false, ActionMetadata.LastActionAdded));
	PlayAnimationAction.Params.AnimName = 'HL_TemplarMeditation';
...

static function X2AbilityTemplate SAVLegacyAssaultRifleUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	local X2Condition_SavWeaponCategory		WeaponCondition;

	// Create the template using a helper function
	Template = Passive('SAVLegacyAssaultRifleUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagRifleUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyAssaultRifleUpgradeMGEffect';
	Effect.AddToHitModifier(default.RIFLE_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.RIFLE_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_AssaultRifle_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('MagnetizedWeapons');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('rifle');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}
static function X2AbilityTemplate SAVLegacyAssaultRifleUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyAssaultRifleUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamRifleUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyAssaultRifleUpgradeBMEffect';
	Effect.AddToHitModifier(default.RIFLE_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.RIFLE_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_AssaultRifle_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_AssaultRifle_MG');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('PlasmaRifle');//Required Tech
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////CANNONS
static function X2AbilityTemplate SAVLegacyCannonUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyCannonUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagCannonUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyCannonUpgradeMGEffect';
	Effect.AddToHitModifier(default.CANNON_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.CANNON_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Cannon_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('GaussWeapons');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('cannon');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}

static function X2AbilityTemplate SAVLegacyCannonUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyCannonUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamCannonUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyCannonUpgradeBMEffect';
	Effect.AddToHitModifier(default.CANNON_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.CANNON_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Cannon_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Cannon_MG');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('HeavyPlasma');//Required Tech
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////SHOTGUNS
static function X2AbilityTemplate SAVLegacyShotgunUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyShotgunUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagShotgunUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyShotgunUpgradeMGEffect';
	Effect.AddToHitModifier(default.SHOTGUN_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.SHOTGUN_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Shotgun_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('MagnetizedWeapons');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('shotgun');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}

static function X2AbilityTemplate SAVLegacyShotgunUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyShotgunUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamShotgunUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyShotgunUpgradeBMEffect';
	Effect.AddToHitModifier(default.SHOTGUN_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.SHOTGUN_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Shotgun_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Shotgun_MG');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('AlloyCannon');//Required Tech
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////SNIPERRIFLES
static function X2AbilityTemplate SAVLegacySniperRifleUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacySniperRifleUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagSniperUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacySniperRifleUpgradeMGEffect';
	Effect.AddToHitModifier(default.SNIPERRIFLE_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.SNIPERRIFLE_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_SniperRifle_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('GaussWeapons');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('sniper_rifle');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}

static function X2AbilityTemplate SAVLegacySniperRifleUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacySniperRifleUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamSniperUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacySniperRifleUpgradeBMEffect';
	Effect.AddToHitModifier(default.SNIPERRIFLE_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.SNIPERRIFLE_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_SniperRifle_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_SniperRifle_MG');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('PlasmaSniper');//Required Tech
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////PISTOLS
static function X2AbilityTemplate SAVLegacyPistolUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyPistolUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagPistolUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyPistolUpgradeMGEffect';
	Effect.AddToHitModifier(default.PISTOL_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.PISTOL_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Pistol_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('MagnetizedWeapons');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('pistol');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}

static function X2AbilityTemplate SAVLegacyPistolUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacyPistolUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamPistolUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacyPistolUpgradeBMEffect';
	Effect.AddToHitModifier(default.PISTOL_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.PISTOL_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Pistol_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Pistol_MG');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////SWORDS
static function X2AbilityTemplate SAVLegacySwordUpgradeMG()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacySwordUpgradeMG', "img:///UILibrary_SavageItems.UIPerk_Unique_MagSwordUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacySwordUpgradeMGEffect';
	Effect.AddToHitModifier(default.SWORD_MGUPGRADE_AIM);
	Effect.AddDamageModifier(default.SWORD_MGUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Sword_CV');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('AutopsyAdventStunLancer');//Required Tech

	WeaponCondition = new class'X2Condition_SavWeaponCategory';
	WeaponCondition.IncludeWeaponCategories.AddItem('sword');//Required Weapon Cat
	Effect.AbilityTargetConditions.AddItem(WeaponCondition);

	return Template;
}
static function X2AbilityTemplate SAVLegacySwordUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVLegacySwordUpgradeBM', "img:///UILibrary_SavageItems.UIPerk_Unique_BeamSwordUpgrade", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVLegacySwordUpgradeBMEffect';
	Effect.AddToHitModifier(default.SWORD_BMUPGRADE_CRITCHANCE, eHit_Crit);
	Effect.AddDamageModifier(default.SWORD_BMUPGRADE_DAMAGE);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Sword_CV');//Weapon Template Names
	NameCondition.IncludeWeaponNames.AddItem('SAV_LEG_Sword_CV');
	Effect.AbilityTargetConditions.AddItem(NameCondition);
	
	Template.Requirements.RequiredTechs.AddItem('AutopsyArchon');//Required Tech
...
static function X2AbilityTemplate SAVAbsoluteZeroUpgradeBM()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVAbsoluteZeroUpgradeBM', "img:///UILibrary_DLC2Images.PerkIcons.UIPerk_freezingbreath", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVAbsoluteZeroUpgradeBMEffect';
	Effect.AddDamageModifier(1, eHit_Crit);
	Effect.AddDamageModifier(2);
	AddSecondaryEffect(Template, Effect);

	NameCondition = new class'XMBCondition_WeaponName';
	NameCondition.IncludeWeaponNames.AddItem('SAV_Unique_AbsoluteZero');//Weapon Template Names
	Effect.AbilityTargetConditions.AddItem(NameCondition);
...
static function X2AbilityTemplate SAVAbsoluteZeroUpgradeViperKing()
{
	local X2AbilityTemplate									Template;
	local XMBEffect_ConditionalBonus				Effect;
	local XMBCondition_WeaponName				NameCondition;
	...
	// Create the template using a helper function
	Template = Passive('SAVAbsoluteZeroUpgradeViperKing', "img:///UILibrary_DLC2Images.PerkIcons.UIPerk_freezinglash", true);

// Create a conditional bonus for the Aim bonus
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'SAVAbsoluteZeroUpgradeViperKingEffect';
	Effect.AddToHitModifier(10, eHit_Crit);
	...
	Template.Requirements.RequiredTechs.AddItem('AutopsyViperKing');//Required Tech
...
static function X2AbilityTemplate CreateSAVPrototypePowerFluctuation()
{
	...
	local XMBCondition_WeaponName			WeaponCondition2;
	...
	WeaponCondition2 = new class'XMBCondition_WeaponName';
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_PrototypeLaserRifle');
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_PrototypeLaserRifle_Perfected');
	AddTriggerTargetCondition(Template, WeaponCondition2);
...
//Positive aim effect
	...
	Effect1.AbilityTargetConditions.AddItem(Condition);
	Effect1.AbilityTargetConditions.AddItem(WeaponCondition);
	Effect1.AbilityTargetConditions.AddItem(WeaponCondition2);
//Negative aim effect
...
//Positive crit chance
	...
	Effect3.AbilityTargetConditions.AddItem(WeaponCondition2);
//Negative damage
	...
	Effect4.AbilityTargetConditions.AddItem(WeaponCondition);
...
//Positive crit damage
	...
	Effect5.AbilityTargetConditions.AddItem(Condition);
	Effect5.AbilityTargetConditions.AddItem(WeaponCondition);
	Effect5.AbilityTargetConditions.AddItem(WeaponCondition2);
//Pierce bonus
	...
	Effect6.AbilityTargetConditions.AddItem(Condition);
	Effect6.AbilityTargetConditions.AddItem(WeaponCondition);
	Effect6.AbilityTargetConditions.AddItem(WeaponCondition2);
...
static function X2AbilityTemplate CreateSAVDefectivePowerSupply2()
{
	local X2AbilityTemplate 				Template;
	local X2Effect_DisableWeapon 			DisableWeaponEffect;
	local X2AbilityToHitCalc_PercentChance	ApplyChance;
	...
	// Create the template using a helper function
	Template = SelfTargetTrigger('SAVDefectivePowerSupply2', "img:///UILibrary_SavageItems.0_4_Perks.UnreliableAmmo", false, DisableWeaponEffect, 'AbilityActivated');

	//Has a chance to trigger
	ApplyChance = new class'X2AbilityToHitCalc_PercentChance';
	ApplyChance.PercentToHit = 5;
	Template.AbilityToHitCalc = ApplyChance;
...
static function X2AbilityTemplate SAVQuicksilverHands()
{
	local X2AbilityTemplate                 Template;
	local X2AbilityCost_Ammo                AmmoCost;
	local X2Effect_ApplyWeaponDamage        WeaponDamageEffect;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAVQuicksilverHands');

	// Icon Properties
	Template.IconImage = "img:///UILibrary_SavageItems.UIPerk_Unique_Quicksilver_Shot";
...
static function X2AbilityTemplate SAVQuicksilverReactions()
{
	local X2AbilityTemplate                 Template;
	local XMBEffect_ConditionalBonus Effect1, Effect2;
	local XMBCondition_AbilityName AbilityNameCondition;
	...
	AbilityNameCondition = new class'XMBCondition_AbilityName';
	AbilityNameCondition.IncludeAbilityNames.AddItem('SAVQuicksilverHands');
	AbilityNameCondition.IncludeAbilityNames.AddItem('LightningHands');	

	WeaponCondition = new class'XMBCondition_WeaponName';
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_Quicksilver');
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_Quicksilver_Improved');
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_Quicksilver_Perfected');	

	Effect1 = new class'XMBEffect_ConditionalBonus';
	Effect1.AddToHitModifier(20);
	Effect1.AbilityTargetConditions.AddItem(default.ReactionFireCondition);
	Effect1.bDisplayInUI = false;
	Effect1.AbilityTargetConditions.AddItem(WeaponCondition);

	// Create the template using a helper function
	Template = Passive('SAVQuicksilverReactions', "img:///UILibrary_SavageItems.UIPerk_Unique_Quicksilver_Overwatch", true);

	AddIconPassive(Template);

	// Add the XMBEffect_AddItemCharges as an extra effect.
	Effect2 = new class'XMBEffect_ConditionalBonus';
	Effect2.AddToHitModifier(20);
	Effect2.bDisplayInUI = false;
	Effect2.AbilityTargetConditions.AddItem(AbilityNameCondition);
	Effect2.AbilityTargetConditions.AddItem(WeaponCondition);
...
static function X2AbilityTemplate SAVTheVipersBite3()
{
	local X2AbilityTemplate Template;
	local X2Effect_PersistentStatChange PersistentStatChangeEffect;
	local X2Condition_UnitProperty Condition;
	...
	Template = SelfTargetTrigger('SAVTheVipersBite3', "img:///UILibrary_PerkIcons.UIPerk_poisonclaws", false,, 'KillMail');

	PersistentStatChangeEffect = new class'X2Effect_PersistentStatChange';
	PersistentStatChangeEffect.BuildPersistentEffect(4, false, true, false, eGameRule_PlayerTurnBegin);
	PersistentStatChangeEffect.SetDisplayInfo(ePerkBuff_Bonus, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Mobility, 5);
	PersistentStatChangeEffect.AddPersistentStatChange(eStat_Dodge, 40);
	PersistentStatChangeEffect.DuplicateResponse = eDupe_Refresh;
	AddSecondaryEffect(Template, PersistentStatChangeEffect);
	...
	WeaponCondition = new class'XMBCondition_WeaponName';
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Unique_Viperfang_Perfected');
	AddTriggerTargetCondition(Template, WeaponCondition);

	return Template;
}

static function X2AbilityTemplate CreateSAVJaggedEdge()
{
	local X2AbilityTemplate 				Template;
	local XMBCondition_AbilityProperty		Condition;
	local XMBEffect_ConditionalBonus		Effect1, Effect2, Effect3, Effect4;
	local X2Condition_SavWeaponCategory		WeaponCondition;
	local XMBCondition_WeaponName			WeaponCondition2;

	// Create the template using a helper function
	Template = SelfTargetTrigger('SAVJaggedEdge', "img:///UILibrary_SavageItems.UIPerk_Unique_JaggedEdge", false,, 'AbilityActivated');
	...
	WeaponCondition2 = new class'XMBCondition_WeaponName';
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxe');
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxeThrown');
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxe_Enhanced');
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxeThrown_Enhanced');
	AddTriggerTargetCondition(Template, WeaponCondition2);

//Positive aim effect
	Effect1 = class'X2Effect_JaggedAxe'.static.CreateJaggedAxe_AimUp();
	Effect1.ApplyChance = 30;
	Effect1.TargetConditions.AddItem(default.LivingTargetUnitOnlyProperty);
	Effect1.AbilityTargetConditions.AddItem(Condition);
	Effect1.AbilityTargetConditions.AddItem(WeaponCondition);
	Effect1.AbilityTargetConditions.AddItem(WeaponCondition2);
//Positive crit chance
	Effect2 = class'X2Effect_JaggedAxe'.static.CreateJaggedAxe_CritChanceUp();
	...
	Effect2.AbilityTargetConditions.AddItem(WeaponCondition2);
//Positive damage
	Effect3 = class'X2Effect_JaggedAxe'.static.CreateJaggedAxe_DamUp();
	Effect3.ApplyChance = 10;
	Effect3.TargetConditions.AddItem(default.LivingTargetUnitOnlyProperty);
	Effect3.AbilityTargetConditions.AddItem(Condition);
	Effect3.AbilityTargetConditions.AddItem(WeaponCondition);
	Effect3.AbilityTargetConditions.AddItem(WeaponCondition2);
//Positive crit damage
	Effect4 = class'X2Effect_JaggedAxe'.static.CreateJaggedAxe_CritDamUp();
	Effect4.ApplyChance = 15;
	Effect4.TargetConditions.AddItem(default.LivingTargetUnitOnlyProperty);
	Effect4.AbilityTargetConditions.AddItem(Condition);
	Effect4.AbilityTargetConditions.AddItem(WeaponCondition);
...
static function X2AbilityTemplate CreateSAVJaggedEdge3()
{
	local X2AbilityTemplate 				Template;
	local XMBCondition_AbilityProperty		Condition;
	local XMBEffect_ConditionalBonus		Effect1, Effect2, Effect3, Effect4;
	...
	// Create the template using a helper function
	Template = SelfTargetTrigger('SAVJaggedEdge3', "img:///UILibrary_SavageItems.UIPerk_Unique_JaggedEdge", false,, 'AbilityActivated');
	...
	WeaponCondition2 = new class'XMBCondition_WeaponName';
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxe_Perfected');
	WeaponCondition2.IncludeWeaponNames.AddItem('SAV_Unique_JaggedAxeThrown_Perfected');
	AddTriggerTargetCondition(Template, WeaponCondition2);
...
static function X2AbilityTemplate SAVEndlessVengeance_ReactionBonus()
{
	...
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Legendary_EndlessVengeance2');
	WeaponCondition.IncludeWeaponNames.AddItem('SAV_Legendary_EndlessVengeance3');
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.EffectName = 'EndlessVengeance_ReactionBonus';
...
static function X2AbilityTemplate SAV_EndlessVengeance()
{
	...
	NTEEffect.BuildPersistentEffect(1, false, true, false, eGameRule_PlayerTurnEnd);
	...
	NTEEffect.AbilityNames.AddItem('StandardMelee');
	NTEEffect.AbilityNames.AddItem('StandardMovingMelee');
	NTEEffect.AbilityNames.AddItem('SkirmisherMelee');
	NTEEffect.AbilityNames.AddItem('Bayonet');
	NTEEffect.AbilityNames.AddItem('SwordSlice');
...
static function X2AbilityTemplate SAV_EndlessVengeance3()
{
	local X2AbilityTemplate					Template;
	local X2AbilityCharges					Charges;
	local X2AbilityCost_Charges				ChargeCost;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAV_EndlessVengeance3');
...
static function X2AbilityTemplate SAV_EndlessVengeance_Charges()
{
	...
	Effect.AbilityNames.AddItem('SAV_EndlessVengeance3');
	Effect.BonusCharges = 1;
	Effect.MaxCharges = 3;
...
static function X2AbilityTemplate SAV_OE_Demolition()
{
	local X2AbilityTemplate						Template;
	local X2AbilityCost_Ammo					AmmoCost;
	local X2Effect_ApplyDirectionalWorldDamage  WorldDamage;
	...
	local X2Effect_PersistentStatChange			HeadsDnEffect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAV_OE_Demolition');

	Template.ShotHUDPriority = class'UIUtilities_Tactical'.const.CLASS_SERGEANT_PRIORITY;
	Template.AbilitySourceName = 'eAbilitySource_Item';
	Template.eAbilityIconBehaviorHUD = eAbilityIconBehavior_AlwaysShow;
	Template.IconImage = "img:///UILibrary_SavageItems.UiPerk_Unique_DemolitionHeadsDn";
	Template.AbilityConfirmSound = "TacticalUI_ActivateAbility";
	Template.bLimitTargetIcons = true;
	...
	WorldDamage.bUseWeaponDamageType = true;
	WorldDamage.bUseWeaponEnvironmentalDamage = false;
	WorldDamage.EnvironmentalDamageAmount = 25;
	WorldDamage.bApplyOnHit = true;
	WorldDamage.bApplyOnMiss = true;
	WorldDamage.bApplyToWorldOnHit = true;
	...
	HeadsDnEffect = class'X2Effect_SAVHeadsDown'.static.CreateSAVHeadsDownEffect();
	Template.AddTargetEffect(HeadsDnEffect);
...
static function X2AbilityTemplate SAV_OE_Demolition_Perfected()
{
	local X2AbilityTemplate						Template;
	local X2AbilityCost_Ammo					AmmoCost;
	local X2Effect_ApplyDirectionalWorldDamage  WorldDamage;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAV_OE_Demolition_Perfected');
	...
	WorldDamage.bUseWeaponDamageType = true;
	WorldDamage.bUseWeaponEnvironmentalDamage = false;
	WorldDamage.EnvironmentalDamageAmount = 35;
	WorldDamage.bApplyOnHit = true;
	WorldDamage.bApplyOnMiss = true;
	WorldDamage.bApplyToWorldOnHit = true;
	WorldDamage.bApplyToWorldOnMiss = true;
...
static function X2AbilityTemplate CreateSAVMedicalProtocolsAMOD()
{
	local X2AbilityTemplate         Template;

	Template = PurePassive('SAVMedicalProtocolsAMOD', "img:///UILibrary_SavageItems.UIPerk_GremlinIntegration_Medical");

	Template.AdditionalAbilities.AddItem('SAVGremlinHeal');
	Template.AdditionalAbilities.AddItem('SAVGremlinStabilize');
	Template.AdditionalAbilities.AddItem('SavRegenSprayGremlin');
	Template.AdditionalAbilities.AddItem('SavRegen2SprayGremlin');
	Template.AdditionalAbilities.AddItem('SavNaniteRegenGremlin');
	Template.AdditionalAbilities.AddItem('SavStimulatorGremlin');
	Template.AdditionalAbilities.AddItem('SAVGremlinAdministerStims');
	Template.AdditionalAbilities.AddItem('SAVGremlinAdministerStims2');
	
	return Template;
}

static function X2AbilityTemplate CreateSAVEngineeringProtocolsAMOD()
{
	local X2AbilityTemplate         Template;

	Template = PurePassive('SAVEngineeringProtocolsAMOD', "img:///UILibrary_SavageItems.UIPerk_GremlinIntegration_Engineering");

	Template.AdditionalAbilities.AddItem('SAVRepairKitGremlin');
	Template.AdditionalAbilities.AddItem('SAVRepairKit2Gremlin');
	Template.AdditionalAbilities.AddItem('PlatingKitGremlin');
...
static function X2AbilityTemplate SAVGremlinHeal()
{
	...
	local X2AbilityCost_ActionPoints        ActionPointCost;
	local X2AbilityCost_Charges             ChargeCost;
	local X2AbilityCharges_SAVGremlinMedikits      Charges;
	local X2Condition_UnitProperty          UnitPropertyCondition;
...
//NEEDS to use charges from the item ability////////////////////////
	Charges = new class'X2AbilityCharges_SAVGremlinMedikits';
...
//Icon and override stuff
	Template.eAbilityIconBehaviorHUD = eAbilityIconBehavior_ShowIfAvailable;
//	Template.OverrideAbilities.AddItem('RepairKitRepairOrganic');
...
{
	local X2AbilityTemplate                 Template;
	local X2AbilityCharges_GremlinRepair2   Charges;
	local X2AbilityCost_Charges				ChargeCost;
	local X2AbilityCost_ActionPoints        ActionPointCost;
	local X2Condition_UnitProperty          UnitPropertyCondition;
	local X2Condition_AbilityProperty		AbilityConditionEngineering;
...
//NEEDS to use charges from the item ability////////////////////////
	Charges = new class'X2AbilityCharges_GremlinRepair2';
	Template.AbilityCharges = Charges;
////////////////////////////////////////////////////////////////////
	ChargeCost = new class'X2AbilityCost_Charges';
	ChargeCost.NumCharges = 1;
...
static function X2AbilityTemplate MEDAmod_RegenBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_RegenBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SavRegenSprayGremlin');
	AddSecondaryEffect(Template, Effect);

	//add item condition
	AbilityCondition = new class'X2Condition_AbilityProperty';
	AbilityCondition.OwnerHasSoldierAbilities.AddItem('SAVMedicalProtocol');
	Effect.TargetConditions.AddItem(AbilityCondition);

	return Template;
}

static function X2AbilityTemplate MEDAmod_Regen2BonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_Regen2BonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SavRegen2SprayGremlin');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_NanoRegenBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_NanoRegenBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SavNaniteRegenGremlin');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_CombatStimsBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_CombatStimsBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SAVGremlinAdministerStims');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_CombatStims2BonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_CombatStims2BonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SAVGremlinAdministerStims2');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_StimulatorBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_StimulatorBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SavStimulatorGremlin');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_MedikitBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_MedikitBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SAVGremlinHeal');
	AddSecondaryEffect(Template, Effect);
...
static function X2AbilityTemplate MEDAmod_NanoMedikitBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('MEDAmod_NanoMedikitBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);
...
static function X2AbilityTemplate EngAmod_RepairKitBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('EngAmod_RepairKitBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 1;
	Effect.AbilityNames.AddItem('SAVRepairKitGremlin');
	AddSecondaryEffect(Template, Effect);

	//add item condition
	AbilityCondition = new class'X2Condition_AbilityProperty';
	AbilityCondition.OwnerHasSoldierAbilities.AddItem('SAVEngineeringProtocol');
	AbilityCondition.OwnerHasSoldierAbilities.AddItem('RepairKitRepair');
	Effect.TargetConditions.AddItem(AbilityCondition);

	return Template;
}

static function X2AbilityTemplate EngAmod_RepairKit2BonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('EngAmod_RepairKit2BonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);

	Effect = new class'XMBEffect_AddAbilityCharges';
	Effect.BonusCharges = 2;
	Effect.AbilityNames.AddItem('SAVRepairKit2Gremlin');
	AddSecondaryEffect(Template, Effect);

	//add item condition
	AbilityCondition = new class'X2Condition_AbilityProperty';
	AbilityCondition.OwnerHasSoldierAbilities.AddItem('SAVEngineeringProtocol');
	AbilityCondition.OwnerHasSoldierAbilities.AddItem('RepairKitRepair2');
	Effect.TargetConditions.AddItem(AbilityCondition);

	return Template;
}

static function X2AbilityTemplate EngAmod_PlatingKitGremlinBonusUses()
{
	local XMBEffect_AddAbilityCharges       Effect;
	local X2AbilityTemplate					Template;
	local X2Condition_AbilityProperty		AbilityCondition;

	Template = Passive('EngAmod_PlatingKitGremlinBonusUses', "img:///UILibrary_SavageItems.NewPerks.UIPerk_GenericAMODAbility", false);
	HidePerkIcon(Template);
...
static function X2AbilityTemplate CreateSAV_CQBPCSAbility()
{
	local X2AbilityTemplate 				Template;
	local XMBEffect_ConditionalBonus 		Effect, Effect2;
	local X2Condition_SAVMapPropertyPlot	Condition;	

	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AbilityTargetConditions.AddItem(TargetWithinTiles(8));
	Effect.AddToHitModifier(10, eHit_Success);
	Effect.AddToHitModifier(-15, eHit_Graze);
	Effect.AddToHitAsTargetModifier(15, eHit_Graze);
	Effect.AddToHitModifier(10, eHit_Crit);

	Condition = new class'X2Condition_SAVMapPropertyPlot';
	Condition.AllowedPlots.AddItem("Abandoned");
	Condition.AllowedPlots.AddItem("Abandoned_Indoors");
	Condition.AllowedPlots.AddItem("Abandoned_Occluded");
	Condition.AllowedPlots.AddItem("CityCenter");
	Condition.AllowedPlots.AddItem("CityCenter");
	Condition.AllowedPlots.AddItem("Rooftops");
	Condition.AllowedPlots.AddItem("Slums");
	Condition.AllowedPlots.AddItem("Tunnels_Reverb");
...
/*	Condition.bSupply = true;
	...
	Condition.bNeutralize = true;
	Condition.bDefend = true; 
	Condition.bRescue = true; 
	Condition.bTrain = true;
	Condition.bVehicle = true;
*/
	Effect.TargetConditions.AddItem(Condition);

	Template = Passive('SAV_CQBPCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_UrbanWar", true, Effect);

	Effect2 = new class'XMBEffect_ConditionalBonus';
	Effect2.AbilityTargetConditions.AddItem(TargetWithinTiles(8));
	Effect2.AddToHitModifier(5, eHit_Success);
	Effect2.AddToHitModifier(-20, eHit_Graze);
	Effect2.AddToHitAsTargetModifier(10, eHit_Graze);
...
static function X2AbilityTemplate CreateSAVAddledMind()
{
	local X2AbilityTemplate                 Template;	
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;


	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAVAddledMind');
	Template.IconImage = "img:///UILibrary_SavageItems.0_4_Perks.AddledMind";
...
static function X2AbilityTemplate CreateSAVTraumaticExperience()
{
	local X2AbilityTemplate                 Template;	
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;


	`CREATE_X2ABILITY_TEMPLATE(Template, 'SAVTraumaticExperience');
	Template.IconImage = "img:///UILibrary_SavageItems.UIPerk_ACS_ADVENTControl";
...
static function X2AbilityTemplate CreateADVPCSSuspectLoyalty()
{
	local X2AbilityTemplate                 Template;	
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect, SkirmisherEffect;
	local X2Condition_UnitProperty			SkirmCondition;
	
	`CREATE_X2ABILITY_TEMPLATE(Template, 'ADVPCSSuspectLoyalty');
	Template.IconImage = "img:///UILibrary_SavageItems.0_4_Perks.Traumatised";
...
//when used, uses of medical items are free for that turn, lose will and chance to panic
static function X2AbilityTemplate CreateSAV_MedicalPCSAbility()
{
	local XMBEffect_AbilityCostRefund	Effect;
	local XMBCondition_WeaponName		Condition;
	local X2AbilityTemplate				Template;
	...
	Condition = new class'XMBCondition_WeaponName';
	Condition.IncludeWeaponNames.AddItem('Medipack');
	Condition.IncludeWeaponNames.AddItem('Medikit');
	Condition.IncludeWeaponNames.AddItem('NanoMedikit');
	Condition.IncludeWeaponNames.AddItem('SavRegen');
	Condition.IncludeWeaponNames.AddItem('SavRegen2');
	Condition.IncludeWeaponNames.AddItem('SavNaniteRegen');
	Condition.IncludeWeaponNames.AddItem('SavStimulator');
	Condition.IncludeWeaponNames.AddItem('SavStimGun');
	Condition.IncludeWeaponNames.AddItem('SavStimGun2');

	// Create an effect that will uses of Medical items
	Effect = new class'XMBEffect_AbilityCostRefund';
	Effect.EffectName = 'SAVPCSMedicalEmergency';
	Effect.BuildPersistentEffect(1, false, true, false, eGameRule_PlayerTurnEnd);
	Effect.TriggeredEvent = 'SAVPCSMedicalEmergency';
	Effect.MaxRefundsPerTurn = 1;
	Effect.VisualizationFn = EffectFlyOver_Visualization;
	Effect.AbilityTargetConditions.AddItem(Condition);
	Effect.VisualizationFn = EffectFlyOver_Visualization;

	Template = SelfTargetActivated('SAV_MedicalPCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_Medical", true, Effect,, eCost_Free);
	AddCooldown(Template, 3);

	PanicEffect = class'X2StatusEffects'.static.CreatePanickedStatusEffect();
	PanicEffect.ApplyChance = 10;
	AddSecondaryEffect(Template, PanicEffect);
...
//non turn ending standard shots, reloads if can see more than 3 enemies
static function X2AbilityTemplate CreateSAV_OverwhelmedPCSAbility()
{
	local X2AbilityTemplate					Template;
...
//	Effect.SetDisplayInfo(ePerkBuff_Bonus, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage, false, , Template.AbilitySourceName);
	...
	Effect.AbilityNames.AddItem('PistolStandardShot');
	Effect.AbilityNames.AddItem('SniperStandardFire');
	Effect.AbilityNames.AddItem('Reload');//Yeah its niche but threw it in there for players who use turnending reloads.

	Template = SelfTargetActivated('SAV_OverwhelmedPCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_Overwhelmed", true, Effect,, eCost_Free);
...
static function X2AbilityTemplate CreateSAV_OverwhelmedPassivePCSAbility()
{
	local X2AbilityTemplate Template;
	local XMBEffect_ConditionalBonus Effect;
	local XMBValue_Visibility Value;
	...
	Value = new class'XMBValue_Visibility';
	Value.bCountAllies = false;
	Value.bCountEnemies = true;
	Value.bCountNeutrals = false;
	Value.bSquadsight = false;

	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddToHitAsTargetModifier(-3);
	Effect.AddToHitModifier(2);
	Effect.ScaleValue = Value;
	Effect.ScaleMax = 10;

	Template = Passive('SAV_OverwhelmedPassivePCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_Overwhelmed", true, Effect);

	return Template;
}

//reduced spotting range, concealed crit chance
static function X2AbilityTemplate CreateSAV_StealthPCSAbility()
{
	local XMBEffect_ConditionalStatChange Effect;

	Effect = new class'XMBEffect_ConditionalStatChange';
	Effect.AddPersistentStatChange(eStat_CritChance, 25);
	Effect.AddPersistentStatChange(eStat_DetectionModifier, 0.88f);
	Effect.Conditions.AddItem(new class'XMBCondition_Concealed');

	return Passive('SAV_StealthPCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_Partisan", true, Effect);
}

//Def, dodge bonus while in cover, limited slow regen
static function X2AbilityTemplate CreateSAV_SurvivalPCSAbility()
{
	local X2AbilityTemplate					Template;
	local X2Effect_PersistentStatChange		PersistentStatChangeEffect;
	local X2Effect_Regeneration				RegenerationEffect;
	...
	Template = SelfTargetTrigger('SAV_SurvivalPCSAbility', "img:///UILibrary_SavageItems.0_4_Perks.PCS_Survivor", false, PersistentStatChangeEffect, 'UnitTakeEffectDamage');
	
	//The Regen Works!
	RegenerationEffect = new class'X2Effect_Regeneration';
	RegenerationEffect.BuildPersistentEffect(1, true, true, false, eGameRule_PlayerTurnEnd);
	RegenerationEffect.HealAmount = 1;
	RegenerationEffect.MaxHealAmount = 8;
	RegenerationEffect.DuplicateResponse = eDupe_Allow;
	RegenerationEffect.HealthRegeneratedName = 'SAV_SurvivalPCSAbilityHealthRegenerated';
	RegenerationEffect.bRemoveWhenTargetDies = true;
...
static function X2AbilityTemplate SAVPCSMarkTarget()
{
	local X2AbilityTemplate Template;
	local X2Effect_Persistent MarkedEffect;

	Template = TargetedDebuff('SAVPCSMarkTarget', "img:///UILibrary_SavageItems.UIPerk_ACS_MarkTarget", true,,, eCost_Single);

	//// Create the Marked effect
	MarkedEffect = class'X2StatusEffects'.static.CreateMarkedEffect(2, false);
	AddSecondaryEffect(Template, MarkedEffect);

	AddCharges(Template, 3);
...
static function X2AbilityTemplate SAVPCSEnhancedReflexes()
{
	local X2AbilityTemplate Template;
	local XMBEffect_ConditionalBonus Effect;
	...
	Effect = new class'XMBEffect_ConditionalBonus';
	Effect.AddToHitModifier(15);
	Effect.AddToHitAsTargetModifier(35, eHit_Graze);
	Effect.AbilityTargetConditions.AddItem(default.ReactionFireCondition);

	// Create the template as a passive with no effect. This ensures we have an ability icon all the time. - ///////////////////////---Needs a new Icon
	Template = Passive('SAVPCSEnhancedReflexes', "img:///UILibrary_SavageItems.UIPerk_ACS_Reflexes", true, Effect);

	return Template;
}

static function X2AbilityTemplate SAVPCSAdventSecurityPass()
{
	local X2AbilityTemplate							Template;
	local XMBEffect_AddAbility 					ConcealEffect;
	local X2Effect_PersistentStatChange	PersistentEffect;

//Environment conditional?

	ConcealEffect = new class'XMBEffect_AddAbility';
	ConcealEffect.AbilityName = 'Stealth';
	ConcealEffect.BuildPersistentEffect(1, true, false, false, eGameRule_PlayerTurnBegin);
	
	// Create the template as a passive with no effect. This ensures we have an ability icon all the time. - ///////////////////////---Needs a new Icon
	Template = Passive('SAVPCSAdventSecurityPass', "img:///UILibrary_SavageItems.UIPerk_ACS_Hacking", true, ConcealEffect);

//Infiltration-bypass security towers
	...
	PersistentEffect.AddPersistentStatChange(eStat_Hacking, 25);
	AddSecondaryEffect(Template, PersistentEffect);
